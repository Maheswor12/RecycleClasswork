package com.maheswor.recycleclasswork.adapter;
...
import com.maheswor.recycleclasswork.R;
import com.maheswor.recycleclasswork.model.DetailsClass;
...
public class AdapterView extends RecyclerView.Adapter<AdapterView.ContactsViewHolder> {
    ...
    public AdapterView.ContactsViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.recycleviewprofile, parent, false);
